...
<script>
  ...
  input: () => {
    ...
    document.getElementById('input-text-html-example').code = `<cpy-input type="text" label="Text Input" value="Test value" size="large"></cpy-input>`;
    ...
    document.getElementById('input-text-methods').tableData = [

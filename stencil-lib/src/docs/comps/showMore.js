(function () {  
  ...
  document.getElementById('comp-props').tableData = [
    ...
    { name: 'show-more-text', description: 'Text to display in button when text is truncated', type: "string", default: "'show more'", required: false },
    { name: 'show-less-text', description: 'Text to display in button when text is expanded', type: "string", default: "'show less'", required: false },
